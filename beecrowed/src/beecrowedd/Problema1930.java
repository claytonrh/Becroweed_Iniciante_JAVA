...
public class Main {
    ...
    public static void main (String[] args){
        ...
        String[] tomadas = input.nextLine().replaceAll(" ", " ").split(" ");
        
        int t1 = Integer.parseInt(tomadas[0]);
        int t2 = Integer.parseInt(tomadas[1]);
        int t3 = Integer.parseInt(tomadas[2]);
        int t4 = Integer.parseInt(tomadas[3]);
        
        int aparelhos = t1 + t2 + t3 + t4 - 3;
